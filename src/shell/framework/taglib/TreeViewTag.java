    ...
    private void tree(Iterator<TreeViewObject> it, StringBuffer sb, int level) {
        ...
        while (it.hasNext()) {
            ...
            if (obj.getType() == TreeViewObject.HAS_SUB_NODE) {
                ...
                sb.append("<img id=\"foldheader\" onClick=\"change()\" style=\"cursor: pointer;\" align=\"ABSMIDDLE\" src=\"" + imgfold + "\">\n");
                this.buildSuperLink(sb, obj);
                sb.append(obj.getName());
                sb.append("</a>\n");
                sb.append("</div>\n");
                sb.append("<div id=\"DIV_" + obj.getId() + "\" style=\"display:block\">\n");
