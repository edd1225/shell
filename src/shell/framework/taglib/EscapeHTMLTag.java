...
public class EscapeHTMLTag extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            pageContext.getOut().println(replaceRT2BR(escapeHTMLTags(str)));
        }
     ...
     * @return String
     */
    public static final String replaceRT2BR(String in) {
    ...
    public static void main(String[] args) {
        System.out.println(replaceRT2BR(escapeHTMLTags("apple\r\n<b>apple</b>\r\n<apple>red</apple><li>wazfxsqtt!\r\n")));
    }
