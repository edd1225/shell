      ...
      <table width="80%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="98%" height="70" align="center">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="right" width="19%"><img src="<%=request.getContextPath()%>/framework/images/9-25m.gif" width="42" height="42"></td>
        ...
        <tr>
          ...
          <td width="98%" bgcolor="#D9E6F4" height="60" align="center">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" class="a2"><img src="<%=request.getContextPath()%>/framework/images/9-25o.gif" width="42" height="13" border="0" style="cursor:pointer;" alt="确定" onclick="shutup(0);"></td>
              </tr>
            </table>
          </td>
