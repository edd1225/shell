      ...
      <table width="80%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="81%" align="left">
                	<font color="#FF0000">
                <%-- 	<%=msg==null?"³öÒì³£ÁË":msg.replaceAll("\n","<br>")%>  --%>
                	</font>
                </td>
              </tr>
            </table>
        ...
        <tr>
          ...
          <td width="98%" bgcolor="#D9E6F4" height="60" align="center">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" class="a2"><img src="<%=request.getContextPath()%>/framework/images/9-25o.gif" width="42" height="13" border="0" style="cursor:hand" alt="error" onclick="shutup(0);"></td>
              </tr>
            </table>
          </td>
